...
const handler = async (m, { conn, text, usedPrefix, command }) => {
  try {
    ...
    if (command === 'playaudio' || command === 'yta' || command === 'ytmp3') {
      try {
    ...
    } else if (command === 'playvideo' || command === 'ytv' || command === 'ytmp4') {
      try {
...
handler.command = handler.help = ['playadio', 'yta', 'ytmp3', 'playvideo', 'ytv', 'ytmp4']
